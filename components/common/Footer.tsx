  ...
  return (
    <footer className="">
      <div className="mx-auto max-w-screen-xl px-4 pb-8 sm:px-6 lg:px-8">
        <div className="pt-8 flex flex-col-reverse md:flex-row items-center justify-between">
          <p className="mt-8 text-xs text-gray-500 dark:text-neutral-200 sm:mt-0">
            VaibDEV &copy; 2024 - Made by Vaibhav Sharma
          </p>

          <ul className="mt-0 flex justify-center gap-6 lg:justify-end">
            <li>
              <Link
                href="https://x.com/vaib_tw"
                rel="noreferrer"
                target="_blank"
